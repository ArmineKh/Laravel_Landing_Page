          ...
          <div class="col-lg-5 col-sm-7">
            <div class="top_left_cont zoomIn wow animated"> 
              ...
              <div class="col-lg-7 col-sm-5">
                {!! Html::image('assets/img/'.$page->images, 'a picture',  array('class' => 'zoomIn wow animated')) !!}
          ...
          <div class="inner_section">
            <div class="row">
              <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right">
               {!! Html::image('assets/img/'.$page->images, 'a picture',  array('class' => 'img-circle delay-03s animated wow zoomIn')) !!}
    ...
    <div class="isotope fadeInLeft animated wow" style="position: relative; overflow: hidden; height: 480px;" id="portfolio_wrapper"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   {{$item->filter}} isotope-item">
        <div class="portfolio_img">
          ...
          <!-- <img src="{{ asset('assets/img/portfolio_pic1.jpg') }}"  alt="Portfolio 1"> -->
        </div>        
    ...
    <div class="team_section clearfix">
      ...
      <div class="team_area">
        <div class="team_box wow fadeInDown delay-0{{($k*3 + 3)}}s">
          ...
          {{Html::image('assets/img/'.$people->emages, '$people->name')}}
